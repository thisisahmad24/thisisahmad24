...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=900&size=60&duration=1&pause=99999&color=FFFFFF&center=true&vCenter=true&repeat=false&width=500&height=80&lines=Ahmad+Hassan" />
...
name     : Ahmad Hassan
alias    : thisisahmad24
degree   : BS Software Engineering (8th Sem)
college  : University of Central Punjab
cgpa     : 3.21 / 4.0
focus    : AI · Full-Stack · SQA · Design
...
```text
Current focus  →  Agentic AI · Multi-Agent Workflows · Fullstack Systems
Learning now   →  LLM Orchestration · System Design · Deep Learning
End goal       →  Scale production-grade AI products worldwide
```
